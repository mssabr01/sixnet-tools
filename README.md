...
Terminal Units (RTUs) that interface directly with the industrial machinery. 

  This final aspect is the focus of this paper. There is a very serious lack of system and application
